...
public class PanelRedirecionar extends JPanel {
	...
	/**
	 * Construtor em que e gerado a tela de redirecionamento juntamente com seus
	...
	public PanelRedirecionar(String operacao, String listagem) {
		...
		panelCadastro.setBackground(new Color(234, 172, 207));
		...
		listagem2.setBackground(new Color(234, 172, 207));
