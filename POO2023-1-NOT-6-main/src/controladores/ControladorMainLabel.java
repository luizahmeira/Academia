...
import telas.PanelInicio;
import telas.PanelMenu;
import telas.PanelRedirecionar;
...
public class ControladorMainLabel {
	...
	public void caminho(int id) {
		...
		if (id == 1) {
			...
			PanelRedirecionar redirecionarInstrutor = new PanelRedirecionar("Instrutores", "Listar ");
			operarTela(id, redirecionarInstrutor);
	...
	public void iniciarValores() {
		//Iniciar alunos
		/*
		 * Aluno aluno = new Aluno("Paulo Muzy",null, null, null, null, 0, 43,185,null,
		 * null, null, 93); BancoDeDados.getAlunos().add(aluno); Aluno aluno1 = new
		 * Aluno("Neymar",30,175,68); BancoDeDados.getAlunos().add(aluno1); Aluno aluno2
		 * = new Aluno("Roberto Dinamite",68,186,50);
		 * BancoDeDados.getAlunos().add(aluno2);
		 * 
		 * //Iniciar Exercicios ArrayList<TipoDeGrupamento> tipo = new
		 * ArrayList<TipoDeGrupamento>(); tipo.add(TipoDeGrupamento.PEITO);
		 * System.out.println(tipo); Exercicio exercicio = new
		 * Exercicio("Supino Reto",tipo,"4x15");
		 * BancoDeDados.getExercicios().add(exercicio);
		 * 
		 * ArrayList<TipoDeGrupamento> tipo1 = new ArrayList<TipoDeGrupamento>();
		 * tipo1.add(TipoDeGrupamento.COSTA); Exercicio exercicio1 = new
		 * Exercicio("Remada Baixa",tipo1,"3x15 Barra Romana");
		 * BancoDeDados.getExercicios().add(exercicio1);
		 * 
		 * ArrayList<TipoDeGrupamento> tipo2 = new ArrayList<TipoDeGrupamento>();
		 * tipo2.add(TipoDeGrupamento.TRICEPS); Exercicio exercicio2 = new
		 * Exercicio("Tríceps Sinuca",tipo2,"3x15 na Corda");
		 * BancoDeDados.getExercicios().add(exercicio2);
		 * 
		 * ArrayList<TipoDeGrupamento> tipo3 = new ArrayList<TipoDeGrupamento>();
		 * tipo3.add(TipoDeGrupamento.OMBRO); Exercicio exercicio3 = new
		 * Exercicio("Desenvolvimento Arnold",tipo3,"3x10 Sentado no banco");
		 * BancoDeDados.getExercicios().add(exercicio3);
		 * 
		 * ArrayList<TipoDeGrupamento> tipo4 = new ArrayList<TipoDeGrupamento>();
		 * tipo4.add(TipoDeGrupamento.BICEPS); Exercicio exercicio4 = new
		 * Exercicio("Scott",tipo4,"3x MAX");
		 * BancoDeDados.getExercicios().add(exercicio4);
		 * 
		 * ArrayList<TipoDeGrupamento> tipo5 = new ArrayList<TipoDeGrupamento>();
		 * tipo5.add(TipoDeGrupamento.QUADRICEPS); Exercicio exercicio5 = new
		 * Exercicio("Cadeira Extensora",tipo5,"2x50");
		 * BancoDeDados.getExercicios().add(exercicio5);
		 * 
		 * ArrayList<TipoDeGrupamento> tipo6 = new ArrayList<TipoDeGrupamento>();
		 * tipo6.add(TipoDeGrupamento.POSTERIOR); Exercicio exercicio6 = new
		 * Exercicio("Stiff",tipo6,"3x10 na barra");
		 * BancoDeDados.getExercicios().add(exercicio6);
		 * 
		 * ArrayList<TipoDeGrupamento> tipo7 = new ArrayList<TipoDeGrupamento>();
		 * tipo7.add(TipoDeGrupamento.PANTURRILHA); Exercicio exercicio7 = new
		 * Exercicio("Cavalinho",tipo7,"4x15 + max");
		 * BancoDeDados.getExercicios().add(exercicio7);
		 * 
		 * ArrayList<TipoDeGrupamento> tipo8 = new ArrayList<TipoDeGrupamento>();
		 * tipo8.add(TipoDeGrupamento.AEROBICO); Exercicio exercicio8 = new
		 * Exercicio("Corrida",tipo8,"15 minutos no 14 para atingir 3 km");
		 * BancoDeDados.getExercicios().add(exercicio8);
		 * 
		 * // Inicializando treinos ArrayList<TipoDeGrupamento> tipo9 = new
		 * ArrayList<TipoDeGrupamento>(); tipo9.add(TipoDeGrupamento.PEITO);
		 * tipo9.add(TipoDeGrupamento.TRICEPS); tipo9.add(TipoDeGrupamento.OMBRO);
		 * ArrayList<Exercicio> exercicios = new ArrayList<Exercicio>();
		 * exercicios.add(exercicio); exercicios.add(exercicio2);
		 * exercicios.add(exercicio3); Treino treinos = new
		 * Treino("Treino pesado de peito",tipo9,exercicios,3,10);
		 * anexarTreino("Paulo Muzy", treinos); BancoDeDados.getTreinos().add(treinos);
		 * 
		 * ArrayList<TipoDeGrupamento> tipo10 = new ArrayList<TipoDeGrupamento>();
		 * tipo10.add(TipoDeGrupamento.COSTA); tipo10.add(TipoDeGrupamento.BICEPS);
		 * ArrayList<Exercicio> exercicios1 = new ArrayList<Exercicio>();
		 * exercicios1.add(exercicio1); exercicios1.add(exercicio4); Treino treinos2 =
		 * new Treino("Treino pesado de costas",tipo10,exercicios1,3,10);
		 ...
		 * tipo11.add(TipoDeGrupamento.PANTURRILHA); ArrayList<Exercicio> exercicios3 =
		 * new ArrayList<Exercicio>(); exercicios3.add(exercicio5);
		 * exercicios3.add(exercicio6); exercicios3.add(exercicio7); Treino treinos3 =
		 * new Treino("Treino pesado de perna",tipo11,exercicios3,3,10);
		 ...
		 * tipo12.add(TipoDeGrupamento.AEROBICO); ArrayList<Exercicio> exercicios4 = new
		 * ArrayList<Exercicio>(); exercicios4.add(exercicio8); Treino treinos4 = new
		 * Treino("Corrida pesada",tipo12,exercicios4,3,10); anexarTreino("Paulo Muzy",
		 * treinos4); BancoDeDados.getTreinos().add(treinos4);
		 */
	 ...
	 * ArrayList<Treino> adicionar = new ArrayList<Treino>(); for (Aluno aluno :
	 * BancoDeDados.getAlunos()) { if (aluno.getNome() == alunoNome) {
	 * adicionar.addAll(aluno.getTreinos()); if (adicionar.size() < 4) {
	 * adicionar.add(treinos); } aluno.setTreinos(adicionar); } } }
	 */
}
