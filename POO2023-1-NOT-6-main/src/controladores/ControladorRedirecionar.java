...
public class ControladorRedirecionar {
	...
	public static void caminho(int id) {
		...
		if (id == 1) {
			...
			PanelCadastroInstrutor cadastroI = new PanelCadastroInstrutor();
			operarTela(id, cadastroI);
		} else if (id == 4) {
			...
			PanelBuscaInstrutor listarI = new PanelBuscaInstrutor();
			operarTela(id, listarI);
		} else if (id == 7) {
